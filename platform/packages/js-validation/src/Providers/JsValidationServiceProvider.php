...
class JsValidationServiceProvider extends ServiceProvider
{
    ...
    {
        $this->setNamespace('packages/js-validation')
        ...
        if ($this->app['config']->get('packages.js-validation.js-validation.disable_remote_validation') === false) {
    ...
    public function register()
    {
        $this->app->singleton('js-validator', function ($app) {
            $config = $app['config']->get('packages.js-validation.js-validation');
